...
<div class="comment-box">
  <div class="item">
    ...
    <div class="comment-reply">
      ...
      <div v-for="reply in comment.user_replys" :key="reply.reply.id" class="comment-replay-item">
        <div class="text">
          <div class="avatar">
...
.comment-box .item .comment-header .like {
  padding-left: 25px;
  background: transparent url(../assets/imgs/comment-like.png) no-repeat 0;
...
.comment-box .item .comment-reply .comment-replay-item.official .avatar {
  background: transparent url(../assets/imgs/milogo.png) no-repeat 50%;
