...
export default {
  ...
  methods: {
    init() {
      ...
      // let buy_option = productData.buy_option
      ...
      //若选中的商品id等于默认sku商品id，则为购买商品
      this.selectedGood = this.goodsInfo.find(item => {
        return String(item.goods_id) === String(default_goods_id)
      })
