  ...
  <div class="app-shell">
    <div class="app-view-wrapper">
      <div class="app-view">
        <div class="container fluid" v-if="productData">
          ...
          <div class="swiper-container gallery-view">
            <div class="swiper-wrapper">
              <div v-for="(imgUrl,index) in galleryView" :key="index" class="swiper-slide">
                <!-- 图片预加载data- -->
          ...
          <div class="product-section more">
            <div class="border-top-1px ui-flex align-start justify-start J_linksign-customize">
              ...
              <div class="flex pt1-2x">
                <div class="ui-flex align-center justify-start act-icon mb2x" v-if="canJoinActs">
          ...
          <div class="product-section padding-16-32" v-if="selectedGood &&selectedGood.service_refound_policy_list">
            ...
            <div class="tab-view">
              <div 
                ...
                <a 
                  ...
                  class="show-all-desc">查看全部图文详情 &gt;</a>
              </div>
            </div>
          </div>
          <MiRecommend :id="id"/>
        ...
        <!-- 父组件监听close事件执行SKU -->
        <MiSKU :showSKU="showSKU" :productData="productData" @close="closeSKU" @selectSKU="selectSKU"/>
        <footer>
          <div class="fill-height layout align-center">
